        ...
        <table className="w-full text-[13px]">
          <thead className="table-head">
            <tr>
              ...
              <th className="border-y px-3 py-2 text-right">Document Total</th>
  ...
  return (
    ...
    >
      ...
      <table className="w-full text-[13px]">
        <thead className="table-head">
          <tr>
            <th className="border-y px-3 py-2">Account</th>
            <th className="border-y px-3 py-2">Description</th>
      ...
      {!rows?.length ? (
        ...
        <table className="w-full text-[13px]">
          <thead className="table-head">
            <tr>
              <th className="border-y px-3 py-2">Date</th>
              <th className="border-y px-3 py-2">Entry</th>
              <th className="border-y px-3 py-2">Narration</th>
              <th className="border-y px-3 py-2 text-right">Debit</th>
              <th className="border-y px-3 py-2 text-right">Credit</th>
