        ...
        <table className={`text-[13px] ${tags.length ? "w-max min-w-full" : "w-full"}`}>
          <thead className="table-head">
            <tr>
              ...
              <th className="border border-[#ece3d5] px-2 py-2">Details</th>
              {config.withAccountColumn && <th className="w-44 border border-[#ece3d5] px-2 py-2">Account</th>}
              <th className="w-20 border border-[#ece3d5] px-2 py-2">Qty</th>
              <th className="w-28 border border-[#ece3d5] px-2 py-2">Rate</th>
              <th className="w-20 border border-[#ece3d5] px-2 py-2">Disc %</th>
              {config.withTax && <th className="w-32 border border-[#ece3d5] px-2 py-2">Tax</th>}
              {tags.map((t) => (
                <th key={t.id} className="w-40 border border-[#ece3d5] px-2 py-2 whitespace-nowrap">
                  {t.name}
                </th>
              ))}
              <th className="w-28 border border-[#ece3d5] px-2 py-2 text-right">Amount</th>
